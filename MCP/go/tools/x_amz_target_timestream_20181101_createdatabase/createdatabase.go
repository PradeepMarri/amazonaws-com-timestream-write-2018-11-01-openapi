...
func CreatedatabaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateDatabaseRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Timestream_20181101.CreateDatabase", cfg.BaseURL)
		...
		var result models.CreateDatabaseResponse
...
func CreateCreatedatabaseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Timestream_20181101_CreateDatabase",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatedatabaseHandler(cfg),
	}
}
