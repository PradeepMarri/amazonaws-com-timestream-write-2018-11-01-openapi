...
func ListtablesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListTablesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Timestream_20181101.ListTables%s", cfg.BaseURL, queryString)
		...
		var result models.ListTablesResponse
...
func CreateListtablesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Timestream_20181101_ListTables",
		mcp.WithDescription("Provides a list of tables, along with the name, status, and retention properties of each table. See <a href="https://docs.aws.amazon.com/timestream/latest/developerguide/code-samples.list-table.html">code sample</a> for details. "),
		...
		mcp.WithString("DatabaseName", mcp.Description("")),
