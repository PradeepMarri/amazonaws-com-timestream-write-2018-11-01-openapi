...
func DeletedatabaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteDatabaseRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Timestream_20181101.DeleteDatabase", cfg.BaseURL)
...
func CreateDeletedatabaseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Timestream_20181101_DeleteDatabase",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletedatabaseHandler(cfg),
	}
}
